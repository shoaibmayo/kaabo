@extends('layouts.app',['title' => 'Kaabo'])
@section('content')
    ...
    <div class="section division">
        <img src="{{asset('/img/network-header.jpg')}}">
    ...
    <div class="section division">
        ...
        <img src="{{asset('/img/5673735.jpg')}}">
    </div>
    <div class="section division">
        <img src="{{asset('/img/accommodation-header.jpg')}}">
        <div class="flex-section">
    ...
    <div class="section division">
        ...
        <img src="{{asset('/img/jobs-header.jpg')}}">
    </div>
    <div class="section division">
        <img src="{{asset('/img/explore-header.jpg')}}">
        <div class="flex-section">
    ...
    <div class="section images" id="service">
        <img src="{{asset('/img/app-img.png')}}">
        <img src="{{asset('/img/app-img-2.png')}}">
        <img src="{{asset('/img/app-img-3.png')}}">
    </div>
    <div class="main-section-index">
        ...
        <a class="try-out-button" href="{{url('/login')}}">Try Out Now</a>
        <img src="{{asset('/img/app-img.png')}}">
    </div>
